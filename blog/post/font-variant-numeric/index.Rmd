...
![San Francisco (more accurately, SF Pro Text)](/image/tnum-sf-pro.png)

Apple's previous defaults, Helvetica Neue and Lucida Grande:

![Helvetica Neue](/image/tnum-helvetica-neue.png)

![Lucida Grande](/image/tnum-lucida-grande.png)

Segoe UI for Windows:

![Segoe UI](/image/tnum-segoe-ui.png)

Roboto for Android:

![Roboto](/image/tnum-roboto.png)

Oh, last but not least:

![](/image/font-typeface-batman-slapping-robin-meme.png)
