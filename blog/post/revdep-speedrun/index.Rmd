...
![Monument Valley Navajo Tribal Park, Saint Michaels, United States.
...
For my test, I chose data.table, an R package for blazing fast and
memory-efficient tabular data manipulation. It is one of the
[most depended upon packages](https://r-pkg.org/depended) on CRAN
(ranking 15th at the time of writing), and has helped countless package
