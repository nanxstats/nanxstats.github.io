...
> CAUTION: It might be better not to encode too many categories in different colors.
...
> NOTE: For technical reasons, the raw color data for the iTerm color palettes
> and color scales (`pal_iterm()`, `scale_*_iterm()`) introduced in
> ggsci 4.0.0 are stored in a separate object `ggsci:::ggsci_db_iterm`
> rather than `ggsci:::ggsci_db`.
>
> You can access the two variants ("normal" and "bright") of these
> palettes via, for example, `ggsci:::ggsci_db_iterm[["Palette Name"]][["normal"]]`
> and `ggsci:::ggsci_db_iterm[["Palette Name"]][["bright"]]`.
