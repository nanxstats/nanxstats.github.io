...
description: >
  ...
  ASCII, removes emoji, and tidies trailing whitespace so AI-generated text
...
em dashes, emoji, and other smart punctuation. They look fine, but they are
...
removes emoji, and cleans up trailing whitespace. Here is a GIF demo:
...
Alternatively, open the Command Palette and choose "Open Settings (JSON)",
