...
> **Update (2025-10-31)**: revdeprun 1.0.0 switched to using a custom workflow
> to pre-install binary dependencies for checking reverse dependencies,
> and run parallel checks using xfun::rev_check(). This improvement
> significantly improves performance and reliability. Read the release notes
> [here](https://github.com/nanxstats/revdeprun/releases/tag/v1.0.0).
...
and run `xfun::rev_check()` with all the sensible defaults.
...
- [`revdepcheck`](https://github.com/r-lib/revdepcheck) from Gábor Csárdi
