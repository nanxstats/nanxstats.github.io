...
All these features would help me focus on the task instead of the tool better. Among others, [Stan](https://mc-stan.org/) and [Edward](https://edwardlib.org/) were pretty close to achieving these goals.
