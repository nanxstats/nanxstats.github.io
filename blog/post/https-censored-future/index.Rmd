...
One of the good news from the past weeks is that [GitHub Pages finally supports HTTPS for custom domains](https://github.blog/news-insights/product-news/github-pages-custom-domains-https/). The feature that people waited forever eventually arrived. Although this is not too late, we have to admit, moving items out of "backlog" and "roadmap" and implement them [can be a lengthy process](https://github.com/isaacs/github/issues/156).
