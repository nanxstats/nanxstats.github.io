...
make a visual impression. As the portfolio size gets larger, I realized
...
I selected a low-saturated, pastel color palette
[Kopia vintage card](https://color.adobe.com/Kopia-vintage-card-color-theme-11990015/)
to convey a mild, sophisticated message.

![Kopia vintage card color palette.](/image/kopia-vintage-card.png)
