...
I'm happy to announce that stackgbm, a minimalist R package for tree model
...
entire flow become a few consistent, canonical function calls:
...
stackgbm is well-suited for for experimentation and research---when you don't
