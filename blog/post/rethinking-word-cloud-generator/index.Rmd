...
- Add a color palette selection feature, offering a wide range of options
  from Tableau, Viridis, ColorBrewer, ggplot2, D3, Okabe-Ito, and Gephi.
...
Once you have tried different layouts and downloaded the result as
`wordcloud.svg`, it is useful to convert the SVG image to a high-quality,
